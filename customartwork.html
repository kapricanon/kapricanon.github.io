...
{% assign images = site.static_files | where_exp: "file", "file.path contains '/assets/images/customartwork/'" %}
{% for image in images %}
	<a href="{{ image.path }}" data-lightbox="customartwork" data-title="{{ image.name }}">
